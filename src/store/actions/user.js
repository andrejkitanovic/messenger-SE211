...
// export const register = (username, type, email, password) => {
// 	return (dispatch) => {
// 		dispatch(startLoading());
// 		const id = localStorage.getItem('id');
// 		axios
// 			.post('user/signup', { id, username, type, email, password })
// 			.then(({ data }) => {
...
// 		dispatch(startLoading());
// 		axios
// 			.get(`user?id=${localStorage.getItem('id')}`)
// 			.then(({ data }) => {
// 				dispatch(setOtherUsers(data.data));
// 				dispatch(finishLoading());
// 			})
...
// 		dispatch(startLoading());
// 		axios
// 			.get(`user/me?id=${localStorage.getItem('id')}`)
// 			.then(({ data }) => {
